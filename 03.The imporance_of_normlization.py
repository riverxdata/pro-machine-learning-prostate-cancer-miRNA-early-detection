...
# Choose only 2 features
# Select input
# inputs=list(cols)
inputs=["MIMAT0027654", "MIMAT0031000"]
...
# valid
# Absolutely wrong, need to scale before run the prediction
performance(clf,X,y)

# Correct
X_all=scaler.transform(X)
normalize1=performance(clf,X_all,y)
...
# Correct
X_all=scaler.transform(X)
normalize2=performance(clf,X_all,y)

# Try to change with GradidentBoosting methods and concludes
